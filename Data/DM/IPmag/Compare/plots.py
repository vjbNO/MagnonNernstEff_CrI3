...
if __name__ == '__main__':
    ...
    fig1.savefig('Plots/DM_IP_PosMinusNegXgrad_MuZ.pdf')
    fig2.savefig('Plots/DM_IP_PosMinusNegXgrad_MuZav.pdf')
    
    
    fig3,fig4=plotDiffBetweenTempGrads(PosYgrad,NegYgrad,'ygrad')
    fig3.savefig('Plots/DM_IP_PosMinusNegYgrad_MuZ.pdf')
    fig4.savefig('Plots/DM_IP_PosMinusNegYgrad_MuZav.pdf')
